																	...
																	<tr>
																		<td valign="top" style="padding:40px 20px 0">
																			<div id="body_content_inner" style="color:#333333;font-family:'Montserrat',Arial,Helvetica,sans-serif;font-size:14px;line-height:150%;text-align:left">
																				...
																				<p style="display:block;margin:0 0 16px"><?php _e('Thank you for registering on the Jobs & Career Platform of Das Falke Personal GmbH! From now on all functions are available to find your next employee.', 'dasfalke-email'); ?></p>

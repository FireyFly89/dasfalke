																	...
																	<tr>
																		<td valign="top" style="padding:40px 20px 0">
																			<div id="body_content_inner" style="color:#333333;font-family:'Montserrat',Arial,Helvetica,sans-serif;font-size:14px;line-height:150%;text-align:left">
																				<p style="display:block;margin:0"><?php echo __('Job posting: ', 'dasfalke-email') . $_POST['job_title']; ?></p>
																				<p style="display:block;margin:0"><?php echo __('Applicant: ', 'dasfalke-email') . $_POST['first_name'] . ' ' . $_POST['last_name']; ?></p>
																				<p style="display:block;margin:0"><?php echo __('Email Address: ', 'dasfalke-email') . $_POST['account_email']; ?></p>
																				<p style="display:block;margin:0 0 16px"><?php echo __('Message: ', 'dasfalke-email') . $_POST['job_application_freetext']; ?></p>

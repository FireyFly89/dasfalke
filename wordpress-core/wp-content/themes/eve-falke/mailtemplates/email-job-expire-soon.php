																	...
																	<tr>
																		<td valign="top" style="padding:40px 20px 0">
																			<div id="body_content_inner" style="color:#333333;font-family:'Montserrat',Arial,Helvetica,sans-serif;font-size:14px;line-height:150%;text-align:left">
																				<h2 style="text-align:center;font-size:18px"><?php _e('Book More Job Posts', 'dasfalke-email'); ?></h2>
																				<p style="display:block;margin:0 0 16px"><?php _e('Dear customer,', 'dasfalke-email'); ?></p>
																				<p style="display:block;margin:0 0 30px"><?php sprintf(__('Your job posting titled <strong>%s</strong> is about to expire. Do you want to receive more applications for this job? No problem, just open Ad Management and enter a new posting.', get_the_title($active_job->post_id))); ?></p>
																				<p style="text-align:center;margin:30px 0;"><a style="background: #3E76EB; border: 2px solid #3E76EB; -webkit-border-radius: 14px; border-radius: 14px; box-shadow: 0 3px 6px rgba(62,118,235,0.3); color: #ffffff; font-weight: bold; font-size: 12px; line-height: 1; outline: none; text-decoration: none; padding: 7px 15px; text-align: center;" href="<?php echo get_the_permalink($active_job->post_id); ?>" target="_blank"><?php echo esc_html__( 'Preview', 'dasfalke-profile' ); ?></a></p>
																				<p style="display:block;margin:0 0 30px"><?php echo esc_html__( 'Of course we are happy if you place more job posts! Choose your suitable package from your overview.', 'dasfalke-email' ); ?></p>
																				<p style="text-align:center;margin:30px 0;"><a style="background: #3E76EB; border: 2px solid #3E76EB; -webkit-border-radius: 14px; border-radius: 14px; box-shadow: 0 3px 6px rgba(62,118,235,0.3); color: #ffffff; font-weight: bold; font-size: 12px; line-height: 1; outline: none; text-decoration: none; padding: 7px 15px; text-align: center;" href="https://dasfalkepersonal.at/anzeigenpakete/" target="_blank"><?php echo esc_html__( 'BUY JOB POSTINGS NOW', 'dasfalke-email' ); ?></a></p>
																				<p style="display:block;margin:0"><?php echo esc_html__( 'Best regards and good luck in search for a new employee,', 'dasfalke-email' ); ?></p>

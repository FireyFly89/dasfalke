																	...
																	<tr>
																		<td valign="top" style="padding:40px 20px 0">
																			<div id="body_content_inner" style="color:#333333;font-family:'Montserrat',Arial,Helvetica,sans-serif;font-size:14px;line-height:150%;text-align:left">
																				...
																				<p style="display:block;margin:0 0 16px"><?php _e('You have hopefully made the company curious with your application . Use the time well to prepare for the job interview when they get in contact with you.', 'dasfalke-email'); ?></p>
																				<p style="display:block;margin:0"><?php echo __('Name: ', 'dasfalke-email') . $_POST['first_name'] . ' ' . $_POST['last_name']; ?></p>
